...
export class AuthService
{
    ...
    signIn(credentials: { username: string; password: string }): Observable<any>
    {
        ...
        return this._httpClient.post(environment.API+'login_check', credentials).pipe(
     ...
     * @param user
     */
     signUp(user :RestaurantOwner): Observable<any> {
        return this._httpClient.post(AUTH_API + 'restaurant_owners', {
          email: user.email,
      ...
      add_restaurant(restaurant :Restaurant): Observable<any> {
        return this._httpClient.post(AUTH_API + 'restaurants', restaurant, httpOptions)
      
    
      }
      link_restaurant(restaurant :Restaurant): Observable<any> {
        return this._httpClient.put(AUTH_API + 'restaurant_owners', restaurant, httpOptions);
      }
